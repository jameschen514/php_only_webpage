...
if (isset($page) && isset($session_id))
{
    ...
    switch($page) {
        case "home":
            ...
            $query = "select article_id, article_title, article_caption, image_id, image_path, image_name, image_width, image_height, image_alt, image_status from cms_article, cms_image where article_id = article_image_id = $page_id";
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="20"><input type="checkbox" id="images" name="images" /></td>
